...
(def responses (vector ">Chatbot: Hello, thanks for visiting" 
                       ">Chatbot: Good to see you again" 
                       ">Chatbot: Hi there, how can I help?"))

(defn greeting
  "Using similarity function, identifies if the user-input is in possible-greetings.
   If true, function prints random greeting message, otherwise retruns false."
